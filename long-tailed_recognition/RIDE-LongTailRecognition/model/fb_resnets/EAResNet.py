...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_experts, dropout=None, num_classes=1000, use_norm=False, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, share_layer3=False, top_choices_num=5, pos_weight=20, share_expert_help_pred_fc=True, force_all=False, s=30, add_bt=False):
        self.inplanes = 64
        ...
        if add_bt:
            ...
            # self.encoder_layers = torch.nn.TransformerEncoderLayer(self.inplanes, 4, self.inplanes, 0.5)
        if self.use_dropout:
            print('Using dropout.')
