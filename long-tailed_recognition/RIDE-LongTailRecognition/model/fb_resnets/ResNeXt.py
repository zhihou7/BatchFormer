...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, groups=1, width_per_group=64, dropout=None, num_classes=1000, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, add_bt=False):
        self.inplanes = 64
        ...
        if add_bt:
            ...
            # self.encoder_layers = nn.TransformerEncoderLayer(self.inplanes, 4, self.inplanes, 0.5)
