...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, dropout=None, num_classes=1000, use_norm=False, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, load_pretrained_weights=False, returns_feat=False, s=30, add_bt=False):
        self.inplanes = 64
